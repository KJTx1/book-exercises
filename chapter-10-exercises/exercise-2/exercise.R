...
highest_raise_name <- salaries[salaries$annual_salary_adjustments == highest_raise, "employees"]

# What was the largest decrease in salaries between the two years?
largest_cut <- min(salaries$annual_salary_adjustments)

# What was the name of the employee who recieved largest decrease in salary?
lowest_raise_name <- salaries[salaries$annual_salary_adjustments == largest_cut, "employees"]
